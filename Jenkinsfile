...
stages {  
    stage('Build Frontend in Staging') {  
        ...
        steps {  
            ...
            // Use GitHub token securely
            withCredentials([usernamePassword(credentialsId: 'github-fullswing', usernameVariable: 'GIT_USERNAME', passwordVariable: 'GIT_TOKEN')]) {  
                    ...
                    script {  
                        ...
                        try {  
                            sh """  
                                ...
                                # Configure Git with username and token
                                git remote set-url origin https://$GIT_USERNAME:$GIT_TOKEN@github.com/maheshhadiya11/fullswingsports-frontend.git;  
                                git fetch --all;  
